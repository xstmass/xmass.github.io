(function () {
	...
	var TRASH_R = ['$$$####!!!!!!!', '^^^^^^##@', '@!^^!@#@@$$$$$', '^^#@@!!@#!$', '@#!@@@##$$@@'];
	var version_modss = '3.1', API = Protocol() + 'api.lampa.stream/', type = '', jackets = {}, cards, ping_auth, manifest, menu_list = [], vip = true, leftVipD = '1231', user_id = 99999, uid = 'qweqwe125418', IP = '76.7.3.76', logged = false;
	...
	var Modss = {
      ...
      if(Lampa.Storage.get('showModssVip', false)) setTimeout(function (){
        Modss.showModssVip();
    ...
    sources: function () {
      ...
      Lampa.Modal.render().find('.cub-premium__descr:eq(1)').text('У вас осталось ' + 1488);
	  ...
	  rating_kp_imdb:function (card) {
        ...
        Pub.network.clear();
          ...
          // if((!vip && logged == 'false' && leftVipD !== json.data.leftDays && auth && json.data.vip) || (vip && logged == true && leftVipD !== json.data.leftDays && auth=='false' && !json.data.vip)) window.location.reload();
  				...
  				/*if(json.data.leftDays) */leftVipD = 1488;
          ...
          var kp_rating = !isNaN(kp) && kp !== null ? parseFloat(kp).toFixed(1) : '0.0';
  			  ...
  			  uid: uid,
  			  ips: '95.26.113.93',
          id: 'YWxleGZpbDExMkBnbWFpbC5jb20=',
          auth: logged
  			});
			});
		}, 
    ...
    auth: function(kp) {
      ...
      return {
		...
		balansers: function() {
		  var balansers = {"videocdn":"VideoCDN","collaps":"Collaps","filmix":"Filmix","rezka":"Rezka","hdr":"MODS's [4K, HDR]  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","kinopub":"KinoPub 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","alloha":"Alloha 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","hdrezka":"HDRezka 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","zetflix":"Zetflix  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","uakino":"UAKino 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","eneida":"Eneida(Ukr)  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","kodik":"Kodik  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","anilibria":"Anilibria  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","hdvb":"HDVB  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","kinobase":"Kinobase","cdnmovies":"CDNmovies","kinotochka":"KinoTochka  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","mango":"ManGo 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","kinofit":"KinoFit 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>"};
  ...
  function rezka(component, _object) {
    ...
    var embed = prox ? prox + 'http://voidboost.org/' : 'https://voidboost.org/';
    var object = _object;
    var select_id = '';
    var filter_items = {};
    var choice = {
    ...
    this.filter = function (filter_items, choice) {
      ...
      filter.set('sort', filter_sources.map(function (e, i) {
        var tpl = {
          ...
          source: e,
          selected: e == balanser, 
          ghost: i >= (Lampa.Storage.get('pro_pub', false) ? 5 : 4) ? true : false
        };
        if(i >= (Lampa.Storage.get('pro_pub', false) ? 5 : 4)) {
  ...
  function forktv(object) {
	...
	function collection(object) {
  	...
  	var html = $('<div></div>');
  	var body = $('<div class="category-full"></div>');
  	var cors = object.sour == 'rezka' || object.sourc == 'rezka' ? Lampa.Utils.protocol() + 'cors.lampa.stream/' : object.sour == 'filmix' || object.sourc == 'filmix' ? 'http://corsanywhere.herokuapp.com/' : '';
	...
	function startPlugin() {
      ...
      title_prioriry_balanser_descr: {
        ...
        Lampa.SettingsApi.addParam({
          ...
          field: {
            name: '🆔 1488 🔹  💻 Windows NOT For You 10.0 (x64)'
          }
        });
			...
			Lampa.SettingsApi.addParam({
				...
				field: {
					name: '<img width="150px" src="'+API.replace('api.','')+'/group.jpg">',
      ...
      Lampa.SettingsApi.addParam({
    	...
    	Lampa.SettingsApi.addParam({
		  ...
		  //Proxy mods
			...
			['VideoCDN', 'HDRezka', 'Collaps'].forEach(function (itm) {
				Lampa.SettingsApi.addParam({
					component: 'mods_proxy',
					param: {
